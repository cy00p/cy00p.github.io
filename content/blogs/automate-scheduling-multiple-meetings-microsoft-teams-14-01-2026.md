...
slug: automate-scheduling-multiple-meetings-microsoft-teams-14-01-2026
...
![dummy excel data](../../src/assets/automate-scheduling-multiple-meetings-microsoft-teams-14-01-2026/image.png)
...
![email message body](../../src/assets/automate-scheduling-multiple-meetings-microsoft-teams-14-01-2026/image%201.png)
...
![Power Automate Landing Page](../../src/assets/automate-scheduling-multiple-meetings-microsoft-teams-14-01-2026/image%202.png)
...
![Starting a workflow](../../src/assets/automate-scheduling-multiple-meetings-microsoft-teams-14-01-2026/image%203.png)
...
![image.png](../../src/assets/automate-scheduling-multiple-meetings-microsoft-teams-14-01-2026/image%204.png)
...
![blank power automate canvas](../../src/assets/automate-scheduling-multiple-meetings-microsoft-teams-14-01-2026/image%205.png)
...
![adding the list-rows-present-in-a-table action](../../src/assets/automate-scheduling-multiple-meetings-microsoft-teams-14-01-2026/image%206.png)
...
![Creating a table in our workbook](../../src/assets/automate-scheduling-multiple-meetings-microsoft-teams-14-01-2026/image%207.png)
...
![editing table name to dummyTable](../../src/assets/automate-scheduling-multiple-meetings-microsoft-teams-14-01-2026/image%208.png)
...
![finishing the excel data retrieval action](../../src/assets/automate-scheduling-multiple-meetings-microsoft-teams-14-01-2026/image%209.png)
...
![adding the create-a-teams-meeting action](../../src/assets/automate-scheduling-multiple-meetings-microsoft-teams-14-01-2026/image%2010.png)
...
![image.png](../../src/assets/automate-scheduling-multiple-meetings-microsoft-teams-14-01-2026/image%2011.png)
...
![image.png](../../src/assets/automate-scheduling-multiple-meetings-microsoft-teams-14-01-2026/image%2012.png)

 **

Now, you should be able to see the 4 fields from your table e.g. First Name, email, and now select *First Name*.

![image.png](../../src/assets/automate-scheduling-multiple-meetings-microsoft-teams-14-01-2026/image%2013.png)
...
![image.png](../../src/assets/automate-scheduling-multiple-meetings-microsoft-teams-14-01-2026/image%2014.png)
...
![image.png](../../src/assets/automate-scheduling-multiple-meetings-microsoft-teams-14-01-2026/image%2015.png)
...
![introducing startime and endtime dates](../../src/assets/automate-scheduling-multiple-meetings-microsoft-teams-14-01-2026/image%2016.png)
...
![image.png](../../src/assets/automate-scheduling-multiple-meetings-microsoft-teams-14-01-2026/image%2017.png)
...
![image.png](../../src/assets/automate-scheduling-multiple-meetings-microsoft-teams-14-01-2026/image%2018.png)
...
![modified excel data](../../src/assets/automate-scheduling-multiple-meetings-microsoft-teams-14-01-2026/image%2019.png)
...
![running the flow](../../src/assets/automate-scheduling-multiple-meetings-microsoft-teams-14-01-2026/image%2020.png)

Now here’s how Teams looks after running the workflow:

![Teams view after running Flow](../../src/assets/automate-scheduling-multiple-meetings-microsoft-teams-14-01-2026/image%2021.png)

And here’s the email on the candidate’s side:

![email, as received by a candidate](../../src/assets/automate-scheduling-multiple-meetings-microsoft-teams-14-01-2026/image%2022.png)
